...
global.github = process.env.GITHUB || "https://github.com/Wavyworlds/WASI-MD-V2";
...
global.owner = process.env.OWNER_NUMBER || "233276419464";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-Clang😍",
  author: process.env.PACK_AUTHER || "Clang",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "Zay Clang",
  ownername: process.env.OWNER_NAME || "Clang",
  errorChat: process.env.ERROR_CHAT || "233276419464",
